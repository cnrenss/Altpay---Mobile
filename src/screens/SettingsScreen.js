...
export default function SettingsScreen() {
    ...
    return (
        <View style={styles.container}>
            ...
            {/* ÜST TARAFTAKİ BİLGİLER*/}
            <View style={styles.borderone}>
                <View style={{flexDirection: 'row',}}>
                    <Image source={require('../assets/gmail.png')} style={styles.borderlogo} />
                    <Text style={styles.bordertext}>erdem@alttantire.com</Text>
                </View>
                <View style={styles.bordercizgi}></View>
                <View style={{flexDirection: 'row',}}>
                    <Image source={require('../assets/phone.png')} style={styles.borderlogo} />
                    <Text style={styles.bordertext}>05452170084</Text>
                </View>
            </View>
            {/*ALT TARAFTAKİ BİLGİLER*/}
            <View style={styles.borderone}>
                <View style={{flexDirection: 'row',alignItems:'center'}}>
                    <Image source={require('../assets/ppsettings.png')} style={styles.borderlogo} />
                    <Text style={styles.bordertextalt}>Hesap Ayarları</Text>
                    <View style={{flex: 1, alignItems: 'flex-end',marginTop:34,}}>
                        <Image source={require('../assets/detay.png')} style={[styles.detaylogo]} />
                    </View>
                </View>
                <View style={styles.bordercizgi}></View>
                <View style={{flexDirection: 'row', alignItems: 'center'}}>
                    <Image source={require('../assets/pppass.png')} style={styles.borderlogo} />
